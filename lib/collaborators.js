...
export async function createCollaborators(collaborators) {
  try {
    const collaboratorsFromDB = await prisma.collaborator.createMany({ data: collaborators, skipDuplicates: true, })
